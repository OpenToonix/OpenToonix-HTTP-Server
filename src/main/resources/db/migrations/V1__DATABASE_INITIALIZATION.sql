...
CREATE TABLE IF NOT EXISTS Verification_tokens (
    Verification_token_id INT UNSIGNED PRIMARY KEY AUTO_INCREMENT,
    Token BINARY(16) NOT NULL UNIQUE,
    Type ENUM('DELETE_ACCOUNT_TOKEN', 'EMAIL_VERIFICATION_TOKEN', 'RESET_PASSWORD_TOKEN') NOT NULL,
    Uses_count TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
    Metadata JSON,
    User_id INT UNSIGNED NOT NULL,
    Created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
